...
public class PurchaseManager : MonoBehaviour, IStoreListener
{
	...
	private static string kProductNameAppleNonConsumable = "xyz.mattpowell.helios.removead";
	// Apple App Store identifier for the non-consumable product.

	private static string kProductNameGooglePlayNonConsumable = "xyz.mattpowell.helios.removead";
	//private static string kProductNameGooglePlayNonConsumable = "android.test.purchased";
	...
	public void InitializePurchasing ()
	{
		...
		builder.Configure<IGooglePlayConfiguration> ().SetPublicKey ("");
	...
	public void RestorePurchases ()
	{
		...
		if (Application.platform == RuntimePlatform.IPhonePlayer ||
			...
			apple.RestoreTransactions ((result) => {
				...
				if (PlayerPrefs.GetInt ("RemoveAds") == 0 && SceneManager.GetActiveScene ().name == "GameOver") {
					BuyNonConsumable ();
				} else if (PlayerPrefs.GetInt ("RemoveAds") == 0 && SceneManager.GetActiveScene ().name == "Home") {
					NativeIOSMessage.showMessage ("No Purchases Found", "There are no previous purchases for this app");
				} else if (PlayerPrefs.GetInt ("RemoveAds") == 1) {
					NativeIOSMessage.showMessage ("Purchases Restored", "Ads have been permanently removed. Thank you for your support!");
				} 
			});
			#endif
		}
